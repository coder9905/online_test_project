...
@Repository
public interface HelperThreeSubjectRepository extends JpaRepository<HelperThreeSubject, UUID> {
    ...
    List<HelperSubjectThreePayload> findAllByHelperThreeSubject(@Param("id") UUID id);
